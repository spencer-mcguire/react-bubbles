...
- [x] Explain what a token is used for.
      ...
      - used for client authentication in your app. essentially logging into an app to expose the private routes.

- [x] What steps can you take in your web apps to keep your data secure?

      - Well this is a loaded question. There is a TON you could do to keep data secure, but what data? Server data? client data?
      Server data can be protected using JWS tokens to hide routes and require a user to log in to display the information.
      Client side there is a TON of stuff you can to do to keep your users safe.
